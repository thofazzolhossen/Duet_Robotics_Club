import User from "../Models/Teammodel.js";
import fs from 'fs';
...
export const addUser = async (req, res) => {
    try {
        const { name, position, description, facebook, email, linkedin, whatsapp } = req.body;
...
export const deleteUser = async (req, res) => {
  ...
  try {
    ...
    const imagePath = path.join(baseDir, 'Upload', 'image', 'team', teamMember.image);
