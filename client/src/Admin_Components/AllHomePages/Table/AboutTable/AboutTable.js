...
const Abouttable = () => {
    ...
    const handleDelete = async (id, image) => {
        try {
          ...
          const response = await axios.delete(`http://localhost:5000/api/about/deleteAbout/${id}`);
    ...
    return (
        ...
        >
            ...
            >
                <h1 className="fw-bold">About List</h1>
                <p className="text-muted">Your About List</p>
            </div>
            ...
            >
                <div className="d-flex justify-content-between align-items-center">
                    <h3 className="text-center mb-4 mx-auto">About Table</h3>
                    <button className="btn btn-primary">
                        <Link to={"/admin/about/addAbout"} style={{ color: "white" }}>
                            Add About
                        </Link>
                    </button>
                </div>
                    ...
                    <table className="table table-striped table-hover table-bordered">
                        ...
                        {teamMembers.map((member,index) => (
                            <tr key={member._id}>
                                ...
                                <td>
                                <img
                                    src={`http://localhost:5000/Upload/image/about/${member.image}`}
                                    alt={member.image}
                                    style={{
                                        width: "70px",
                                        height: "70px",
